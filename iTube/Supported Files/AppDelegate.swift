...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        if UserDefaults.standard.bool(forKey: LOGINSTATUS) {
            ...
            if let userTabViewController = storyBoard.instantiateViewController(withIdentifier: TAB_VIEW_CONTROLLER_IDENTIFIER) as? UserTabViewController {
                self.window?.rootViewController = userTabViewController
            }
            
        }
        
        
        //        GIDSignIn.sharedInstance().clientID = "686089587808-uii2csjubgn7idn1tum4e9l9j6uabem2.apps.googleusercontent.com"
        //
...
//        buttonCreateNotification()
        NotificationCenter.default.post(Notification.init(name: Notification.Name(rawValue: "AppInBackground")))
    ...
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: "iTube")
